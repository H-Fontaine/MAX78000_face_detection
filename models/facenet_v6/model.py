...
class FaceNet(nn.Module):
    ...
    def __init__(self, num_classes=2, dimensions=(88, 88), num_channels=48, bias=False, **kwargs):
        ...
        self.conv2 = ai8x.FusedMaxPoolConv2dReLU(in_channels=num_channels, out_channels=16, kernel_size=3,
                                                 padding=1, bias=bias, **kwargs)
        ...
        self.conv3 = ai8x.FusedMaxPoolConv2dReLU(in_channels=num_channels, out_channels=32, kernel_size=3,
                                                 padding=1, bias=bias, **kwargs)
        # conv padding 1 -> no change in dimensions
        # pooling, padding 0 -> dimensions halved
        dim_x //= 2 # 5
...
def facenet_v6(pretrained=False, **kwargs):
    """
    Constructs a model.
    """
